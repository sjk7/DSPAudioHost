...
typedef enum { KSMETHOD_STREAMIO_READ, KSMETHOD_STREAMIO_WRITE } KSMETHOD_STREAMIO;
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CAPABILITIES(Handler)                        \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CAPABILITIES, (Handler),              \
        sizeof(KSPROPERTY), sizeof(KS_SEEKING_CAPABILITIES), NULL, NULL, 0, NULL, NULL,  \
        0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_TIMEFORMAT(GetHandler, SetHandler)           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_TIMEFORMAT, (GetHandler),             \
        sizeof(KSPROPERTY), sizeof(GUID), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITION(Handler)                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITION, (Handler),                  \
        sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITIONS(Handler)                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITIONS, NULL, sizeof(KSPROPERTY),  \
        sizeof(KSPROPERTY_POSITIONS), (Handler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_AVAILABLE(Handler)                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_AVAILABLE, (Handler),                 \
        sizeof(KSPROPERTY), sizeof(KSPROPERTY_MEDIAAVAILABLE), NULL, NULL, 0, NULL,      \
        NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CONVERTTIMEFORMAT(Handler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CONVERTTIMEFORMAT, (Handler),         \
        sizeof(KSP_TIMEFORMAT), sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_NODES(Handler)                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_NODES, (Handler), sizeof(KSPROPERTY), 0,  \
...
typedef NTSTATUS (*PFNKSINTERSECTHANDLER)(
    PIRP Irp, PKSP_PIN Pin, PKSDATARANGE DataRange, PVOID Data);
typedef NTSTATUS (*PFNKSINTERSECTHANDLEREX)(PVOID Context, PIRP Irp, PKSP_PIN Pin,
...
#define DEFINE_KSPROPERTY_ITEM_PIN_CINSTANCES(Handler)                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CINSTANCES, (Handler), sizeof(KSP_PIN),        \
        sizeof(KSPIN_CINSTANCES), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_PIN_DATARANGES(Handler)                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_DATARANGES, (Handler), sizeof(KSP_PIN), 0,     \
        NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_DATAINTERSECTION(Handler)                             \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_DATAINTERSECTION, (Handler),                   \
        sizeof(KSP_PIN) + sizeof(KSMULTIPLE_ITEM), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_INTERFACES(Handler)                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_INTERFACES, (Handler), sizeof(KSP_PIN), 0,     \
        NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_MEDIUMS(Handler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_MEDIUMS, (Handler), sizeof(KSP_PIN), 0, NULL,  \
        NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_COMMUNICATION(Handler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_COMMUNICATION, (Handler), sizeof(KSP_PIN),     \
        sizeof(KSPIN_COMMUNICATION), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_PIN_NECESSARYINSTANCES(Handler)                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NECESSARYINSTANCES, (Handler),                 \
        sizeof(KSP_PIN), sizeof(ULONG), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_PIN_NAME(Handler)                                         \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NAME, (Handler), sizeof(KSP_PIN), 0, NULL,     \
        NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_PIN_PROPOSEDATAFORMAT(Handler)                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_PROPOSEDATAFORMAT, NULL, sizeof(KSP_PIN),      \
        sizeof(KSDATAFORMAT), (Handler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_PINSETCONSTRAINED(                                             \
    PinSet, PropGeneral, PropInstances, PropIntersection)                                \
    DEFINE_KSPROPERTY_TABLE(PinSet) {                                                    \
        DEFINE_KSPROPERTY_ITEM_PIN_CINSTANCES(PropInstances),                            \
            DEFINE_KSPROPERTY_ITEM_PIN_CTYPES(PropGeneral),                              \
            DEFINE_KSPROPERTY_ITEM_PIN_DATAFLOW(PropGeneral),                            \
...
#define DEFINE_KSPIN_DESCRIPTOR_ITEM(InterfacesCount, Interfaces, MediumsCount, Mediums, \
    DataRangesCount, DataRanges, DataFlow, Communication)                                \
    {                                                                                    \
        InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, \
            DataFlow, Communication, NULL, NULL, 0                                       \
    }

#define DEFINE_KSPIN_DESCRIPTOR_ITEMEX(InterfacesCount, Interfaces, MediumsCount,        \
    Mediums, DataRangesCount, DataRanges, DataFlow, Communication, Category, Name)       \
    {                                                                                    \
        InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount, DataRanges, \
            DataFlow, Communication, Category, Name, 0                                   \
    }
#endif /* _NTDDK_ */
...
DEFINE_GUIDSTRUCT(
    "AA797B40-E974-11CF-A5D6-28DB04C10000", KSDATAFORMAT_SPECIFIER_FILENAME);
...
typedef enum { KSPROPERTY_QUALITY_REPORT, KSPROPERTY_QUALITY_ERROR } KSPROPERTY_QUALITY;

#define DEFINE_KSPROPERTY_ITEM_QUALITY_REPORT(GetHandler, SetHandler)                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_REPORT, (GetHandler), sizeof(KSPROPERTY),  \
        sizeof(KSQUALITY), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_QUALITY_ERROR(GetHandler, SetHandler)                     \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_ERROR, (GetHandler), sizeof(KSPROPERTY),   \
        sizeof(KSERROR), (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_CONNECTION_STATE(GetHandler, SetHandler)                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_STATE, (GetHandler),                    \
        sizeof(KSPROPERTY), sizeof(KSSTATE), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PRIORITY(GetHandler, SetHandler)               \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PRIORITY, (GetHandler),                 \
        sizeof(KSPROPERTY), sizeof(KSPRIORITY), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_DATAFORMAT(GetHandler, SetHandler)             \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_DATAFORMAT, (GetHandler),               \
        sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ALLOCATORFRAMING(Handler)                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ALLOCATORFRAMING, (Handler),            \
        sizeof(KSPROPERTY), sizeof(KSALLOCATOR_FRAMING), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PROPOSEDATAFORMAT(Handler)                     \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PROPOSEDATAFORMAT, NULL,                \
        sizeof(KSPROPERTY), sizeof(KSDATAFORMAT), (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ACQUIREORDERING(Handler)                       \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ACQUIREORDERING, (Handler),             \
        sizeof(KSPROPERTY), sizeof(int), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_STARTAT(Handler)                               \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_STARTAT, NULL, sizeof(KSPROPERTY),      \
        sizeof(KSRELATIVEEVENT), (Handler), NULL, 0, NULL, NULL, 0)
...
typedef NTSTATUS (*PFNKSINITIALIZEALLOCATOR)(
    PVOID InitialContext, PKSALLOCATOR_FRAMING AllocatorFraming, PVOID* Context);
...
#define DECLARE_SIMPLE_FRAMING_EX(                                                       \
    FramingExName, MemoryType, Flags, Frames, Alignment, MinFrameSize, MaxFrameSize)     \
    const KSALLOCATOR_FRAMING_EX FramingExName = {1, 0, {1, 1, 0}, 0,                    \
        {{MemoryType, STATIC_KS_TYPE_DONT_CARE, 0, 0, Flags, Frames, Alignment, 0,       \
            {0, (ULONG)-1, 1}, {{MinFrameSize, MaxFrameSize, 1}, 0, 0}}}}
...
#define SetKsFramingRangeWeighted(                                                       \
    KsFramingRangeWeightedPointer, P_MinFrameSize, P_MaxFrameSize)                       \
    {                                                                                    \
...
#define INITIALIZE_SIMPLE_FRAMING_EX(FramingExPointer, P_MemoryType, P_Flags, P_Frames,  \
    P_Alignment, P_MinFrameSize, P_MaxFrameSize)                                         \
    {                                                                                    \
        ...
        SetKsFramingRangeWeighted(                                                       \
            KsFramingRangeWeighted, P_MinFrameSize, P_MaxFrameSize);                     \
    }
...
#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_ALLOC(Handler)                              \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_ALLOC, KSMETHOD_TYPE_WRITE, (Handler), \
        sizeof(KSMETHOD), sizeof(PVOID), NULL)

#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_FREE(Handler)                               \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_FREE, KSMETHOD_TYPE_READ, (Handler),   \
        sizeof(KSMETHOD), sizeof(PVOID), NULL)
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(Handler)                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMALLOCATOR_FUNCTIONTABLE, (Handler),          \
        sizeof(KSPROPERTY), sizeof(KSSTREAMALLOCATOR_FUNCTIONTABLE), NULL, NULL, 0,      \
        NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(Handler)                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMALLOCATOR_STATUS, (Handler),                 \
        sizeof(KSPROPERTY), sizeof(KSSTREAMALLOCATOR_STATUS), NULL, NULL, 0, NULL, NULL, \
        0)
...
typedef enum { KSPROPERTY_STREAMINTERFACE_HEADERSIZE } KSPROPERTY_STREAMINTERFACE;
...
#define DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE(GetHandler)                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMINTERFACE_HEADERSIZE, (GetHandler),          \
        sizeof(KSPROPERTY), sizeof(ULONG), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_ALLOCATOR(GetHandler, SetHandler)                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_ALLOCATOR, (GetHandler),                    \
        sizeof(KSPROPERTY), sizeof(HANDLE), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_QUALITY(Handler)                                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_QUALITY, (Handler), sizeof(KSPROPERTY),     \
        sizeof(KSQUALITY_MANAGER), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_TIMEFORMAT(Handler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_TIMEFORMAT, (Handler), sizeof(KSPROPERTY),  \
        sizeof(GUID), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PRESENTATIONTIME(GetHandler, SetHandler)           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PRESENTATIONTIME, (GetHandler),             \
        sizeof(KSPROPERTY), sizeof(KSTIME), (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_FRAMETIME(Handler)                                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_FRAMETIME, (Handler), sizeof(KSPROPERTY),   \
        sizeof(KSFRAMETIME), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATECAPABILITY(Handler)                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATECAPABILITY, (Handler),                  \
        sizeof(KSRATE_CAPABILITY), sizeof(KSRATE), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATE(GetHandler, SetHandler)                       \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATE, (GetHandler), sizeof(KSPROPERTY),     \
        sizeof(KSRATE), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PIPE_ID(GetHandler, SetHandler)                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PIPE_ID, (GetHandler), sizeof(KSPROPERTY),  \
        sizeof(HANDLE), (SetHandler), NULL, 0, NULL, NULL, 0)
...
typedef LONGLONG(FASTCALL* PFNKSCLOCK_CORRELATEDTIME)(
    PFILE_OBJECT FileObject, PLONGLONG SystemTime);
...
typedef BOOLEAN (*PFNKSSETTIMER)(
    PVOID Context, PKTIMER Timer, LARGE_INTEGER DueTime, PKDPC Dpc);
typedef BOOLEAN (*PFNKSCANCELTIMER)(PVOID Context, PKTIMER Timer);
typedef LONGLONG(FASTCALL* PFNKSCORRELATEDTIME)(PVOID Context, PLONGLONG SystemTime);
...
#define DEFINE_KSPROPERTY_ITEM_CLOCK_PHYSICALTIME(Handler)                               \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_PHYSICALTIME, (Handler), sizeof(KSPROPERTY), \
        sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_CORRELATEDTIME(Handler)                             \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_CORRELATEDTIME, (Handler),                   \
        sizeof(KSPROPERTY), sizeof(KSCORRELATED_TIME), NULL, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_CLOCK_RESOLUTION(Handler)                                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_RESOLUTION, (Handler), sizeof(KSPROPERTY),   \
        sizeof(KSRESOLUTION), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_STATE(Handler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_STATE, (Handler), sizeof(KSPROPERTY),        \
        sizeof(KSSTATE), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_FUNCTIONTABLE(Handler)                              \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_FUNCTIONTABLE, (Handler),                    \
        sizeof(KSPROPERTY), sizeof(KSCLOCK_FUNCTIONTABLE), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_CLOCKSET(ClockSet, PropTime, PropPhysicalTime,                 \
    PropCorrelatedTime, PropCorrelatedPhysicalTime, PropResolution, PropState,           \
    PropFunctionTable)                                                                   \
...
typedef BOOLEAN (*PFNKSFASTHANDLER)(PFILE_OBJECT FileObject, PKSIDENTIFIER Request,
    ULONG RequestLength, PVOID Data, ULONG DataLength, PIO_STATUS_BLOCK IoStatus);
...
#define DEFINE_KSPROPERTY_ITEM(PropertyId, GetHandler, MinProperty, MinData, SetHandler, \
    Values, RelationsCount, Relations, SupportHandler, SerializedSize)                   \
    {                                                                                    \
        PropertyId, (PFNKSHANDLER)GetHandler, MinProperty, MinData,                      \
            (PFNKSHANDLER)SetHandler, (PKSPROPERTY_VALUES)Values, RelationsCount,        \
            (PKSPROPERTY)Relations, (PFNKSHANDLER)SupportHandler, (ULONG)SerializedSize  \
    }
...
#define DEFINE_KSMETHOD_ITEM(                                                            \
    MethodId, Flags, MethodHandler, MinMethod, MinData, SupportHandler)                  \
...
typedef NTSTATUS (*PFNKSADDEVENT)(
    PIRP Irp, PKSEVENTDATA EventData, struct _KSEVENT_ENTRY* EventEntry);
typedef VOID (*PFNKSREMOVEEVENT)(
    PFILE_OBJECT FileObject, struct _KSEVENT_ENTRY* EventEntry);

#define DEFINE_KSEVENT_TABLE(tablename) const KSEVENT_ITEM tablename[] =

#define DEFINE_KSEVENT_ITEM(                                                             \
...
#define DEFINE_KSDISPATCH_TABLE(tablename, DeviceIoControl, Read, Write, Flush, Close,   \
    QuerySecurity, SetSecurity, FastDeviceIoControl, FastRead, FastWrite)                \
...
typedef NTSTATUS (*PFNKSDEVICEPNPSTART)(PKSDEVICE Device, PIRP Irp,
    PCM_RESOURCE_LIST TranslatedResourceList, PCM_RESOURCE_LIST UntranslatedResourceList);
...
typedef NTSTATUS (*PFNKSDEVICEQUERYPOWER)(PKSDEVICE Device, PIRP Irp,
    DEVICE_POWER_STATE DeviceTo, DEVICE_POWER_STATE DeviceFrom,
    SYSTEM_POWER_STATE SystemTo, SYSTEM_POWER_STATE SystemFrom, POWER_ACTION Action);

typedef void (*PFNKSDEVICESETPOWER)(
    PKSDEVICE Device, PIRP Irp, DEVICE_POWER_STATE To, DEVICE_POWER_STATE From);

typedef NTSTATUS (*PFNKSFILTERFACTORYVOID)(PKSFILTERFACTORY FilterFactory);

typedef void (*PFNKSFILTERFACTORYPOWER)(
    PKSFILTERFACTORY FilterFactory, DEVICE_POWER_STATE State);
...
typedef NTSTATUS (*PFNKSPINSETDEVICESTATE)(
    PKSPIN Pin, KSSTATE ToState, KSSTATE FromState);

typedef NTSTATUS (*PFNKSPINSETDATAFORMAT)(PKSPIN Pin, PKSDATAFORMAT OldFormat,
    PKSMULTIPLE_ITEM OldAttributeList, const KSDATARANGE* DataRange,
...
typedef BOOLEAN (*PFNKSPINSETTIMER)(
    PKSPIN Pin, PKTIMER Timer, LARGE_INTEGER DueTime, PKDPC Dpc);
...
typedef void (*PFNKSPINFRAMERETURN)(
    PKSPIN Pin, PVOID Data, ULONG Size, PMDL Mdl, PVOID Context, NTSTATUS Status);
...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
    ...
    (THIS_ PKSMETHOD Method, ULONG MethodLength, PVOID MethodData, ULONG DataLength,
...
DECLARE_INTERFACE_(IKsDeviceFunctions, IUnknown) {
    ...
    (THIS_ PADAPTER_OBJECT AdapterObject, PDEVICE_DESCRIPTION DeviceDescription,
        ULONG NumberOfMapRegisters, ULONG MaxMappingsByteCount, ULONG MappingTableStride)
        PURE;
};
...
DEFINE_GUID(IID_IKsFastClock, 0xc9902485, 0xc180, 0x11d2, 0x84, 0x73, 0xd4, 0x23, 0x94,
    0x45, 0x9e, 0x5e);
#define STATIC_IID_IKsDeviceFunctions                                                    \
    0xe234f2e2, 0xbd69, 0x4f8c, 0xb3, 0xf2, 0x7c, 0xd7, 0x9e, 0xd4, 0x66, 0xbd
DEFINE_GUID(IID_IKsDeviceFunctions, 0xe234f2e2, 0xbd69, 0x4f8c, 0xb3, 0xf2, 0x7c, 0xd7,
    0x9e, 0xd4, 0x66, 0xbd);
#endif /* _IKsControl_ */
...
KSDDKAPI NTSTATUS NTAPI KsEnableEvent(PIRP Irp, ULONG EventSetsCount,
    const KSEVENT_SET* EventSet, PLIST_ENTRY EventsList, KSEVENTS_LOCKTYPE EventsFlags,
    PVOID EventsLock);

KSDDKAPI NTSTATUS NTAPI KsEnableEventWithAllocator(PIRP Irp, ULONG EventSetsCount,
    const KSEVENT_SET* EventSet, PLIST_ENTRY EventsList, KSEVENTS_LOCKTYPE EventsFlags,
    PVOID EventsLock, PFNKSALLOCATOR Allocator, ULONG EventItemSize);

KSDDKAPI NTSTATUS NTAPI KsDisableEvent(
    PIRP Irp, PLIST_ENTRY EventsList, KSEVENTS_LOCKTYPE EventsFlags, PVOID EventsLock);
...
KSDDKAPI NTSTATUS NTAPI KsPropertyHandlerWithAllocator(PIRP Irp, ULONG PropertySetsCount,
    const KSPROPERTY_SET* PropertySet, PFNKSALLOCATOR Allocator, ULONG PropertyItemSize);

KSDDKAPI BOOLEAN NTAPI KsFastPropertyHandler(PFILE_OBJECT FileObject,
    PKSPROPERTY Property, ULONG PropertyLength, PVOID Data, ULONG DataLength,
...
KSDDKAPI NTSTATUS NTAPI KsMethodHandlerWithAllocator(PIRP Irp, ULONG MethodSetsCount,
    const KSMETHOD_SET* MethodSet, PFNKSALLOCATOR Allocator, ULONG MethodItemSize);

KSDDKAPI BOOLEAN NTAPI KsFastMethodHandler(PFILE_OBJECT FileObject, PKSMETHOD Method,
    ULONG MethodLength, PVOID Data, ULONG DataLength, PIO_STATUS_BLOCK IoStatus,
...
KSDDKAPI NTSTATUS NTAPI KsCreateDefaultAllocatorEx(PIRP Irp, PVOID InitializeContext,
    PFNKSDEFAULTALLOCATE DefaultAllocate, PFNKSDEFAULTFREE DefaultFree,
    PFNKSINITIALIZEALLOCATOR InitializeAllocator, PFNKSDELETEALLOCATOR DeleteAllocator);

KSDDKAPI NTSTATUS NTAPI KsCreateAllocator(HANDLE ConnectionHandle,
    PKSALLOCATOR_FRAMING AllocatorFraming, PHANDLE AllocatorHandle);

KSDDKAPI NTSTATUS NTAPI KsValidateAllocatorCreateRequest(
    PIRP Irp, PKSALLOCATOR_FRAMING* AllocatorFraming);

KSDDKAPI NTSTATUS NTAPI KsValidateAllocatorFramingEx(PKSALLOCATOR_FRAMING_EX Framing,
    ULONG BufferSize, const KSALLOCATOR_FRAMING_EX* PinFraming);

KSDDKAPI NTSTATUS NTAPI KsAllocateDefaultClock(PKSDEFAULTCLOCK* DefaultClock);

KSDDKAPI NTSTATUS NTAPI KsAllocateDefaultClockEx(PKSDEFAULTCLOCK* DefaultClock,
    PVOID Context, PFNKSSETTIMER SetTimer, PFNKSCANCELTIMER CancelTimer,
    PFNKSCORRELATEDTIME CorrelatedTime, const KSRESOLUTION* Resolution, ULONG Flags);
...
KSDDKAPI NTSTATUS NTAPI KsCreateClock(
    HANDLE ConnectionHandle, PKSCLOCK_CREATE ClockCreate, PHANDLE ClockHandle);
...
KSDDKAPI NTSTATUS NTAPI KsPinDataIntersection(PIRP Irp, PKSP_PIN Pin, PVOID Data,
    ULONG DescriptorsCount, const KSPIN_DESCRIPTOR* Descriptor,
    PFNKSINTERSECTHANDLER IntersectHandler);

KSDDKAPI NTSTATUS NTAPI KsPinDataIntersectionEx(PIRP Irp, PKSP_PIN Pin, PVOID Data,
    ULONG DescriptorsCount, const KSPIN_DESCRIPTOR* Descriptor, ULONG DescriptorSize,
    PFNKSINTERSECTHANDLEREX IntersectHandler, PVOID HandlerContext);

KSDDKAPI NTSTATUS NTAPI KsHandleSizedListQuery(
    PIRP Irp, ULONG DataItemsCount, ULONG DataItemSize, const VOID* DataItems);
...
KSDDKAPI NTSTATUS NTAPI KsLoadResource(PVOID ImageBase, POOL_TYPE PoolType,
    ULONG_PTR ResourceName, ULONG ResourceType, PVOID* Resource, PULONG ResourceSize);

KSDDKAPI NTSTATUS NTAPI KsGetImageNameAndResourceId(
    HANDLE RegKey, PUNICODE_STRING ImageName, PULONG_PTR ResourceId, PULONG ValueType);

KSDDKAPI NTSTATUS NTAPI KsMapModuleName(PDEVICE_OBJECT PhysicalDeviceObject,
    PUNICODE_STRING ModuleName, PUNICODE_STRING ImageName, PULONG_PTR ResourceId,
    PULONG ValueType);
...
KSDDKAPI NTSTATUS NTAPI KsReadFile(PFILE_OBJECT FileObject, PKEVENT Event,
    PVOID PortContext, PIO_STATUS_BLOCK IoStatusBlock, PVOID Buffer, ULONG Length,
...
KSDDKAPI NTSTATUS NTAPI KsQueryInformationFile(PFILE_OBJECT FileObject,
    PVOID FileInformation, ULONG Length, FILE_INFORMATION_CLASS FileInformationClass);

KSDDKAPI NTSTATUS NTAPI KsSetInformationFile(PFILE_OBJECT FileObject,
    PVOID FileInformation, ULONG Length, FILE_INFORMATION_CLASS FileInformationClass);

KSDDKAPI NTSTATUS NTAPI KsStreamIo(PFILE_OBJECT FileObject, PKEVENT Event,
    PVOID PortContext, PIO_COMPLETION_ROUTINE CompletionRoutine, PVOID CompletionContext,
    KSCOMPLETION_INVOCATION CompletionInvocationFlags, PIO_STATUS_BLOCK IoStatusBlock,
    PVOID StreamHeaders, ULONG Length, ULONG Flags, KPROCESSOR_MODE RequestorMode);
...
KSDDKAPI NTSTATUS NTAPI KsAllocateExtraData(
    PIRP Irp, ULONG ExtraSize, PVOID* ExtraBuffer);
...
KSDDKAPI BOOLEAN NTAPI KsDispatchFastIoDeviceControlFailure(PFILE_OBJECT FileObject,
    BOOLEAN Wait, PVOID InputBuffer, ULONG InputBufferLength, PVOID OutputBuffer,
    ULONG OutputBufferLength, ULONG IoControlCode, PIO_STATUS_BLOCK IoStatus,
    PDEVICE_OBJECT DeviceObject);

KSDDKAPI BOOLEAN NTAPI KsDispatchFastReadFailure(PFILE_OBJECT FileObject,
    PLARGE_INTEGER FileOffset, ULONG Length, BOOLEAN Wait, ULONG LockKey, PVOID Buffer,
...
KSDDKAPI PIRP NTAPI KsRemoveIrpFromCancelableQueue(PLIST_ENTRY QueueHead,
    PKSPIN_LOCK SpinLock, KSLIST_ENTRY_LOCATION ListLocation,
    KSIRP_REMOVAL_OPERATION RemovalOperation);

KSDDKAPI NTSTATUS NTAPI KsMoveIrpsOnCancelableQueue(PLIST_ENTRY SourceList,
    PKSPIN_LOCK SourceLock, PLIST_ENTRY DestinationList, PKSPIN_LOCK DestinationLock,
    KSLIST_ENTRY_LOCATION ListLocation, PFNKSIRPLISTCALLBACK ListCallback, PVOID Context);

KSDDKAPI VOID NTAPI KsRemoveSpecificIrpFromCancelableQueue(PIRP Irp);

KSDDKAPI VOID NTAPI KsAddIrpToCancelableQueue(PLIST_ENTRY QueueHead, PKSPIN_LOCK SpinLock,
    PIRP Irp, KSLIST_ENTRY_LOCATION ListLocation, PDRIVER_CANCEL DriverCancel);

KSDDKAPI NTSTATUS NTAPI KsAcquireResetValue(PIRP Irp, KSRESET* ResetValue);

KSDDKAPI NTSTATUS NTAPI KsTopologyPropertyHandler(
    PIRP Irp, PKSPROPERTY Property, PVOID Data, const KSTOPOLOGY* Topology);

KSDDKAPI VOID NTAPI KsAcquireDeviceSecurityLock(
    KSDEVICE_HEADER Header, BOOLEAN Exclusive);
...
KSDDKAPI VOID NTAPI KsSetDevicePnpAndBaseObject(
    KSDEVICE_HEADER Header, PDEVICE_OBJECT PnpDeviceObject, PDEVICE_OBJECT BaseObject);
...
KSDDKAPI VOID NTAPI KsSetPowerDispatch(
    KSOBJECT_HEADER Header, PFNKSCONTEXT_DISPATCH PowerDispatch, PVOID PowerContext);
...
KSDDKAPI NTSTATUS NTAPI KsAllocateDeviceHeader(
    KSDEVICE_HEADER* Header, ULONG ItemsCount, PKSOBJECT_CREATE_ITEM ItemsList);
...
KSDDKAPI NTSTATUS NTAPI KsAllocateObjectHeader(KSOBJECT_HEADER* Header, ULONG ItemsCount,
    PKSOBJECT_CREATE_ITEM ItemsList, PIRP Irp, const KSDISPATCH_TABLE* Table);

KSDDKAPI VOID NTAPI KsFreeObjectHeader(KSOBJECT_HEADER Header);

KSDDKAPI NTSTATUS NTAPI KsAddObjectCreateItemToDeviceHeader(KSDEVICE_HEADER Header,
    PDRIVER_DISPATCH Create, PVOID Context, PWSTR ObjectClass,
    PSECURITY_DESCRIPTOR SecurityDescriptor);

KSDDKAPI NTSTATUS NTAPI KsAddObjectCreateItemToObjectHeader(KSOBJECT_HEADER Header,
    PDRIVER_DISPATCH Create, PVOID Context, PWSTR ObjectClass,
    PSECURITY_DESCRIPTOR SecurityDescriptor);

KSDDKAPI NTSTATUS NTAPI KsAllocateObjectCreateItem(KSDEVICE_HEADER Header,
    PKSOBJECT_CREATE_ITEM CreateItem, BOOLEAN AllocateEntry,
...
KSDDKAPI NTSTATUS NTAPI KsForwardAndCatchIrp(
    PDEVICE_OBJECT DeviceObject, PIRP Irp, PFILE_OBJECT FileObject, KSSTACK_USE StackUse);

KSDDKAPI NTSTATUS NTAPI KsSynchronousIoControlDevice(PFILE_OBJECT FileObject,
    KPROCESSOR_MODE RequestorMode, ULONG IoControl, PVOID InBuffer, ULONG InSize,
    PVOID OutBuffer, ULONG OutSize, PULONG BytesReturned);
...
KSDDKAPI NTSTATUS NTAPI KsCacheMedium(
    PUNICODE_STRING SymbolicLink, PKSPIN_MEDIUM Medium, ULONG PinDirection);
...
KSDDKAPI NTSTATUS NTAPI KsRegisterCountedWorker(
    WORK_QUEUE_TYPE WorkQueueType, PWORK_QUEUE_ITEM CountedWorkItem, PKSWORKER* Worker);
...
KSDDKAPI NTSTATUS NTAPI KsCreateTopologyNode(HANDLE ParentHandle,
    PKSNODE_CREATE NodeCreate, ACCESS_MASK DesiredAccess, PHANDLE NodeHandle);
...
KSDDKAPI NTSTATUS NTAPI KsMergeAutomationTables(PKSAUTOMATION_TABLE* AutomationTableAB,
    PKSAUTOMATION_TABLE AutomationTableA, PKSAUTOMATION_TABLE AutomationTableB,
    KSOBJECT_BAG Bag);

KSDDKAPI NTSTATUS NTAPI KsInitializeDriver(PDRIVER_OBJECT DriverObject,
    PUNICODE_STRING RegistryPathName, const KSDEVICE_DESCRIPTOR* Descriptor);
...
KSDDKAPI NTSTATUS NTAPI KsCreateDevice(PDRIVER_OBJECT DriverObject,
    PDEVICE_OBJECT PhysicalDeviceObject, const KSDEVICE_DESCRIPTOR* Descriptor,
    ULONG ExtensionSize, PKSDEVICE* Device);

KSDDKAPI NTSTATUS NTAPI KsInitializeDevice(PDEVICE_OBJECT FunctionalDeviceObject,
    PDEVICE_OBJECT PhysicalDeviceObject, PDEVICE_OBJECT NextDeviceObject,
    const KSDEVICE_DESCRIPTOR* Descriptor);
...
KSDDKAPI void NTAPI KsDeviceRegisterAdapterObject(PKSDEVICE Device,
    PADAPTER_OBJECT AdapterObject, ULONG MaxMappingsByteCount, ULONG MappingTableStride);

KSDDKAPI ULONG NTAPI KsDeviceGetBusData(
    PKSDEVICE Device, ULONG DataType, PVOID Buffer, ULONG Offset, ULONG Length);

KSDDKAPI ULONG NTAPI KsDeviceSetBusData(
    PKSDEVICE Device, ULONG DataType, PVOID Buffer, ULONG Offset, ULONG Length);

KSDDKAPI NTSTATUS NTAPI KsCreateFilterFactory(PDEVICE_OBJECT DeviceObject,
    const KSFILTER_DESCRIPTOR* Descriptor, PWSTR RefString,
    PSECURITY_DESCRIPTOR SecurityDescriptor, ULONG CreateItemFlags,
    PFNKSFILTERFACTORYPOWER SleepCallback, PFNKSFILTERFACTORYPOWER WakeCallback,
...
KSDDKAPI NTSTATUS NTAPI KsFilterFactoryUpdateCacheData(
    PKSFILTERFACTORY FilterFactory, const KSFILTER_DESCRIPTOR* FilterDescriptor);

KSDDKAPI NTSTATUS NTAPI KsFilterFactoryAddCreateItem(PKSFILTERFACTORY FilterFactory,
    PWSTR RefString, PSECURITY_DESCRIPTOR SecurityDescriptor, ULONG CreateItemFlags);
...
void __forceinline KsFilterGenerateEvents(PKSFILTER Filter, const GUID* EventSet,
    ULONG EventId, ULONG DataSize, PVOID Data, PFNKSGENERATEEVENTCALLBACK CallBack,
    PVOID CallBackContext) {
    KsGenerateEvents(
        Filter, EventSet, EventId, DataSize, Data, CallBack, CallBackContext);
}
...
KSDDKAPI void NTAPI KsStreamPointerAdvanceOffsetsAndUnlock(
    PKSSTREAM_POINTER StreamPointer, ULONG InUsed, ULONG OutUsed, BOOLEAN Eject);

KSDDKAPI void NTAPI KsStreamPointerDelete(PKSSTREAM_POINTER StreamPointer);

KSDDKAPI NTSTATUS NTAPI KsStreamPointerClone(PKSSTREAM_POINTER StreamPointer,
    PFNKSSTREAMPOINTER CancelCallback, ULONG ContextSize,
...
KSDDKAPI PIRP NTAPI KsStreamPointerGetIrp(
    PKSSTREAM_POINTER StreamPointer, PBOOLEAN FirstFrameInIrp, PBOOLEAN LastFrameInIrp);

KSDDKAPI void NTAPI KsStreamPointerScheduleTimeout(
    PKSSTREAM_POINTER StreamPointer, PFNKSSTREAMPOINTER Callback, ULONGLONG Interval);
...
#define KsEdit(Object, PointerToPointer, Tag)                                            \
    _KsEdit((Object)->Bag, (PVOID*)(PointerToPointer), sizeof(**(PointerToPointer)),     \
        sizeof(**(PointerToPointer)), (Tag))
...
KSDDKAPI NTSTATUS NTAPI KsRegisterFilterWithNoKSPins(PDEVICE_OBJECT DeviceObject,
    const GUID* InterfaceClassGUID, ULONG PinCount, WINBOOL* PinDirection,
    KSPIN_MEDIUM* MediumList, GUID* CategoryList);

KSDDKAPI NTSTATUS NTAPI KsFilterCreatePinFactory(
    PKSFILTER Filter, const KSPIN_DESCRIPTOR_EX* const PinDescriptor, PULONG PinID);

KSDDKAPI NTSTATUS NTAPI KsFilterCreateNode(
    PKSFILTER Filter, const KSNODE_DESCRIPTOR* const NodeDescriptor, PULONG NodeID);

KSDDKAPI NTSTATUS NTAPI KsFilterAddTopologyConnections(PKSFILTER Filter,
    ULONG NewConnectionsCount, const KSTOPOLOGY_CONNECTION* const NewTopologyConnections);
...
KSDDKAPI NTSTATUS NTAPI KsPinSubmitFrame(
    PKSPIN Pin, PVOID Data, ULONG Size, PKSSTREAM_HEADER StreamHeader, PVOID Context);

KSDDKAPI NTSTATUS NTAPI KsPinSubmitFrameMdl(
    PKSPIN Pin, PMDL Mdl, PKSSTREAM_HEADER StreamHeader, PVOID Context);
...
KSDDKAPI DWORD WINAPI KsCreatePin(HANDLE FilterHandle, PKSPIN_CONNECT Connect,
    ACCESS_MASK DesiredAccess, PHANDLE ConnectionHandle);
KSDDKAPI DWORD WINAPI KsCreateTopologyNode(HANDLE ParentHandle, PKSNODE_CREATE NodeCreate,
